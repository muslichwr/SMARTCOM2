...
return new class extends Migration
{
    ...
    {
        Schema::create('sintaks_tahap_delapans', function (Blueprint $table) {
            $table->id();
            $table->foreignId('sintaks_id')->constrained('sintaks_barus')->onDelete('cascade');
            $table->text('evaluasi_kelompok')->nullable();
            $table->text('refleksi_pembelajaran')->nullable();
    ...
    {
        Schema::dropIfExists('sintaks_tahap_delapans');
    }
};
