...
return new class extends Migration
{
    ...
    {
        Schema::create('sintaks_tahap_limas', function (Blueprint $table) {
            $table->id();
            $table->foreignId('sintaks_id')->constrained('sintaks_barus')->onDelete('cascade');
            $table->string('file_hasil_karya')->nullable(); // File proyek yang diupload
    ...
    {
        Schema::dropIfExists('sintaks_tahap_limas');
    }
};
