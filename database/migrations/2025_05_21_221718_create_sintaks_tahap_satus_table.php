...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('sintaks_tahap_satus', function (Blueprint $table) {
            ...
            $table->text('orientasi_masalah')->nullable(); // Diisi oleh admin/guru, dibaca oleh siswa
            $table->text('rumusan_masalah')->nullable(); // Diisi oleh admin/guru, dibaca oleh siswa
            $table->string('file_indikator_masalah')->nullable(); // File PDF/Word yang diupload siswa
            $table->string('file_hasil_analisis')->nullable(); // File PDF/Word yang diupload siswa
